...
export const COIN_METRIC_STALE_AFTER_MINUTES = 20;
export const COIN_DISCOVERY_STALE_AFTER_MINUTES = 15;
export const METRICS_CRON_FREQUENCY = "0 0 * * *";
export const COIN_DISCOVERY_CRON_FREQUENCY = "5 0 * * *";
